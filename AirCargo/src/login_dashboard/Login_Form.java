...
oldItems = newItems;
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel_title.setText("Air Cargo Login");
        ...
        jButton_register.setBackground(new java.awt.Color(0, 0, 204));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton_register, javax.swing.GroupLayout.DEFAULT_SIZE, 367, Short.MAX_VALUE)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addGap(79, 79, 79)
                            .addComponent(jPanel_message, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE))))
    ...
    private void jButton_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_loginActionPerformed
        ...
        {
            int flag = 0;
            for(int i = 0; i <= UserInfo_UserAmount ; i = i + 2){
                System.out.println("HERE");
                if(username.equals(UserInfo_Array[i]) ){
                    flag = flag +1;
                }
                if(password.equals(UserInfo_Array[i+1]) ){
                    flag = flag +1;
                }
    ...
    private void jButton_registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_registerActionPerformed
        ...
        String reg_username = jTextField_username.getText().trim();
        String reg_password = String.valueOf(jPasswordField_password.getPassword()).trim();
        
        if(!(reg_username.equals("") && reg_password.equals("")))
        {
            UserInfo_UserAmount = UserInfo_UserAmount +1;
            UserInfo_Array = Arrays.copyOf(UserInfo_Array, (UserInfo_UserAmount * UserInfo_Size));

            
            
            
            UserInfo_Array[UserInfo_UserAmount*UserInfo_Size-2] = reg_username;
            UserInfo_Array[UserInfo_UserAmount*UserInfo_Size-1] = reg_password;

            System.out.println("Here in Register");
            System.out.printf("REGISTER FİLL %d, %s %s\n",UserInfo_UserAmount,reg_username, reg_password);
            for(int i = 0; i <= UserInfo_UserAmount ; i = i + 2){
                System.out.printf("USER INFO %s %s\n",UserInfo_Array[i], UserInfo_Array[i+1]);
        ...
        {
            jLabel_message_text.setText("Registiration is unsuccessful");
        }
        /*
            // the login button
